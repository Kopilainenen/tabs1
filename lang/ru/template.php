...
$MESS['TAB_VREMYA_RABOTY_NAME'] = 'Время автономной работы';
$MESS['TAB_GOODS_NAME'] = 'Опции';
$MESS['TAB_SISTEMY_UPRAVLENIYA_NAME'] = 'Системы управления';
$MESS['TAB_UTILIZATSIYA_TEPLA_NAME'] = 'Утилизация тепла';
$MESS['TAB_VARIANTY_ISPOLNENIYA_NAME'] = 'Варианты исполнения';
?>